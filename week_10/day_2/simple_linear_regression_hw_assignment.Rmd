...
summary(model)
```
The regression coefficient for estimated_length indicates that a 1 unit increase in `estimated_length` will result in an increase of 1.2235 of `actual_length`. The r-squared value of 0.64 indicates that 64% of the variance in actual length can be explained by the variance of estimated length in our sample set.
